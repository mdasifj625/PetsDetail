...
import com.visitor.petsdetail.data.PetDbHelper;
...
//        String[] selectionArgs = { "Toto" };
        ...
        // Here the id will be sorted in descending order

//        String sortOrder =
//                PetEntry._ID + " DESC";


        // Perform the the query on content provider using content resolver
